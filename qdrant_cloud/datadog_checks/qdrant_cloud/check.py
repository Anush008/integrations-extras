...
class QdrantCloudCheck(OpenMetricsBaseCheckV2):
    """QdrantCloudCheck derives from OpenMetricsBaseCheckV2, and provides the required check method."""

    __NAMESPACE__ = "qdrant_cloud"
    ...
    def _check_health_endpoint(self, check_type):
        ...
        tags.append(f"qdrant_cloud_{check_type}_url:{check_url}")
